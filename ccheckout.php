...
if($payment_type == 'payonline')
{
    ...
    window.location.href = 'payonline.php';
    </script>
    <?php    
}   
                                ...
                                <div class="accordion__body">
                                    <div class="paymentinfo">
                                        <div class="single-method">
                                            <h2><b> COD <input type="radio" name="payment_type" value="COD"
                                                        required /></b></h2><br>
                                            <h2><b>Online Payment <input type="radio" name="payment_type" value="payonline"
                                                        required /> </b></h2>
                                        </div>
                                    </div>
                                </div>
